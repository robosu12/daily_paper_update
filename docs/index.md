...
<tr><td>2026-02-12</td><td>Variation-aware Flexible 3D Gaussian Editing</td><td>[2602.11638](http://arxiv.org/pdf/2602.11638)</td><td>该论文针对3D高斯泼溅（3DGS）间接编辑方法存在的跨视图不一致、灵活性差和效率低的问题，提出了名为VF-Editor的原生直接编辑框架。其核心贡献与创新点如下：
